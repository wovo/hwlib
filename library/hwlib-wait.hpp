...
// The wait_xx_busy functions are implemented by the targets.
//
// The default wait_xx functions call the wait_xx_busy fyunctions.
// An RTOS can override these defauklts.`
